...
#define NoWork_ObjectChannel_Weapon         ECC_GameTraceChannel6
#define NoWork_ObjectChannel_Projectile		ECC_GameTraceChannel7
#define NoWork_TraceChannel_AimAssist       ECC_GameTraceChannel1
#define NoWork_TraceChannel_Interaction		ECC_GameTraceChannel8
